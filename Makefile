...
ECHO_SERVER_SRCS = $(wildcard $(SRCDIR)/echo_server.c)
ECHO_SERVER_OBJS = $(patsubst $(SRCDIR)/%.c,$(OBJDIR)/tcp/%.o,$(TCP_SERVER_SRCS))
ECHO_SERVER_DEPS = $(TCP_SERVER_OBJS:.o=.d)
ECHO_SERVER_TARGET = $(BINDIR)/echo_server
